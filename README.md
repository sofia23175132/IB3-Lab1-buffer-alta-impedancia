...
|---|---|
| `codigo/generador_ph.ino` | Programa del ESP32 que genera la señal simulada de pH en GPIO25 |
...
1. Abrir `codigo/generador_ph.ino` en el Arduino IDE, seleccionar una placa ESP32 en *Herramientas > Placa* y cargar el programa.
...
3. **Etapa 1:** medir GPIO25 directamente con el multímetro para pH 4, 7 y 10.
